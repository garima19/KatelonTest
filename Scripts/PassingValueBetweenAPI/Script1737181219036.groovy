...
def response2 = WS.sendRequest(findTestObject('API/SOAP/SOAP Service (1)/CountryInfoServiceSoapBinding/CapitalCity', [('CountryCode') : GlobalVariable.Country_Code]))

WS.verifyElementText(response2, 'CapitalCityResponse.CapitalCityResult', CapitalCity)

println 'CapitalCity is :'+CapitalCity

def response3 = WS.sendRequest(findTestObject('API/SOAP/SOAP Service (1)/CountryInfoServiceSoapBinding/CountryCurrency', [('CountryCode') : GlobalVariable.Country_Code]))

WS.verifyElementText(response3, 'CountryCurrencyResponse.CountryCurrencyResult.sISOCode', CurrencyName)

println 'CurrencyName is :'+CurrencyName
